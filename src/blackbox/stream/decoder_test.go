...
func TestReadTag8_8SVB(t *testing.T) {
	...
	outputArray := [][]int64{
		[]int64{-8, -29, 0, 0, 56, -50, 0, 0},
		[]int64{6, 6346, 0, 0, 0, 0, 0, 0},
		[]int64{895, 0, -50, -1, 1, -2, 0, 2},
	}
...
func TestReadTag8_8SVB2(t *testing.T) {
	...
	outputArray := [][]int64{
		[]int64{-26, 0, 0, 0, 0, 0, 0, 0},
		[]int64{-2, 0, 0, 0, 0, 0, 0, 0},
		[]int64{-114591, 0, 0, 0, 0, 0, 0, 0},
	}
...
func TestReadTag2_3S32(t *testing.T) {
	...
	outputArray := [][]int64{
		...
		[]int64{1, -1, -2, 0, 0, 0, 0, 0},

		// 28 (00 011100), 15 (00 001111), -7 (11 111001)
		[]int64{28, 15, -7, 0, 0, 0, 0, 0},

		// -1 (11), -1 (11), -1 (11)
		[]int64{-1, -1, -1, 0, 0, 0, 0, 0},

		// -1 (1111), 5 (0101), 4 (0100)
		[]int64{-1, 5, 4, 0, 0, 0, 0, 0},

		// -3 (111101), -2 (111110), 13 (001101)
		[]int64{-3, -2, 13, 0, 0, 0, 0, 0},

		[]int64{15, 24, 77, 0, 0, 0, 0, 0},

		// 16843009 (00000001 0000000 10000000 100000001), 19777 (01001101 01000001), 155
		[]int64{16843009, 19777, 155, 0, 0, 0, 0, 0},
	}
...
func TestReadTag8_4S16V2(t *testing.T) {
	...
	outputArray := [][]int64{
		[]int64{0, 57, 7, 6, 0, 0, 0, 0},
		[]int64{57, 99, 2, 0, 0, 0, 0, 0},
		[]int64{1, 99, 2, 0, 0, 0, 0, 0},
		[]int64{-1, 214, 16, 32, 0, 0, 0, 0},
	}
